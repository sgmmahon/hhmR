...
Below is an example of the `hhm` function's application. For a more in depth description of it's usage, see the [package vignette](https://sgmmahon.github.io/hhmR/docs/articles/hhmR_overview.html).
...
Below is an of how the `tshhm` function can be used. For a more details, see the [package vignette](https://sgmmahon.github.io/hhmR/docs/articles/hhmR_overview.html).
```
# Import packages
library(dplyr)
