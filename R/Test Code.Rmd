...
#' @title log_seq
#'
#' @description Creates a vector of logarithmicly increasing values between 1 and a specified value `n`.
...
#' @export
#' @importFrom dplyr "%>%"
log_seq = function(n,ln=15,round_values=T) {
...
#' (defaults to `NULL`). If cbrks is supplied, cclrs must have a length one 
#' longer than cbrks.
...
#' round the legend scale to (defaults to 3). If `cbrks` only contains whole 
#' numbers, `lgdps` will default to 0.
